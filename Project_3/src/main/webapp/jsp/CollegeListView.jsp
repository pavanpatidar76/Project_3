...
<% 
	...
	if (list.size()==0){ %>
	 ...
	 <br>
	  ...
	  <div class="col-sm-2"><input placeholder="Subject Name" type="text" id="defaultForm-email"  name="City" class="border"   value="<%=ServletUtility.getParameter("City", request)%>">
</div>
	 <label class="form-check-label" for="check2" style = "width:50px">
       College:
      </label>
