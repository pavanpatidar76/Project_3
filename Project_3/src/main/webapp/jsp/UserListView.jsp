...
<% 
	...
	if (list.size()==0){ %>
	 ...
	 <br>
	  ...
	  <div class="col-sm-2"><input placeholder="firstName" type="text" id="defaultForm-email"  name="firstName" class="border"    value="<%=ServletUtility.getParameter("firstName", request)%>">
</div>&ensp;
	  
	  <label class="form-check-label" for="check2" style = "width:50px">
      LoginId:
      </label>&ensp;
	  <div class="col-sm-2"><input placeholder="Login Id" type="text" id="defaultForm-email"  name="email" class="border"    value="<%=ServletUtility.getParameter("email", request)%>">
</div>&ensp;
	 <label class="form-check-label" for="check2" style = "width:50px">
       Role:
      </label>
