...
<%=student%>
    ...
    <div class="input-group mb-3">
     <div class="form-group input-group">
    	...
    	<input name="physics" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Enter physics" type="text" value="<%=DataUtility.getStringData(dto.getPhysics())%>" >
    ...
    <div class="form-group input-group">
        ...
        <input name="chemistry" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Enter chemistry" type="text" value="<%=DataUtility.getStringData(dto.getChemistry())%>">
   ...
   <div class="form-group input-group">
        ...
        <input name="maths" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Enter maths" type="text" value="<%=DataUtility.getStringData(dto.getMaths())%>">
