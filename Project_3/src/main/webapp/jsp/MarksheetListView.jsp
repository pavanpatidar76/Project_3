...
<label class="form-check-label" for="check2" style = "width:50px">
	  ...
	  <div class="col-sm-2"> <input placeholder="ENter Roll no." type="text" id="defaultForm-email" name="rollNo" class="border"  value="<%=ServletUtility.getParameter("rollNo", request)%>">
</div>
