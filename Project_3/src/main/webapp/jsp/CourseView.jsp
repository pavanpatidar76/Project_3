...
<%} %>                            
	...
	<div class="form-group input-group">
       ...
       <textarea name="description" class="form-control" placeholder="Enter description" type="text" value="<%=DataUtility.getStringData(dto.getDescription())%>"><%=DataUtility.getStringData(dto.getDescription())%></textarea> 
  <%--  <input type="text" name="description" class="form-control" placeholder="Enter Discription" value="<%=DataUtility.getStringData(dto.getDescription()) %>">
   --%>
    </div>
