...
public class SubjectModelHibImpl implements SubjectModelInt{
	...
	public long add(SubjectDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		Long pk=0L;
		  ...
		  SubjectDTO dtoExist=findByName(dto.getSubjectName()); if(dtoExist!=null){
        ...
        try{
			  ...
			  CourseModelInt crModel=ModelFactory.getInstance().getCourseModel(); CourseDTO
			  crDto=crModel.findByPK(dto.getCourseId());
	...
	public void update(SubjectDTO dto) throws ApplicationException, DuplicateRecordException {
		 ...
		 * DuplicateRecordException("Subject already exist"); }
		 */
        Session session=null;
        Transaction transaction=null;
        try{
