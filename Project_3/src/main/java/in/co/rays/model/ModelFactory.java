...
public class ModelFactory {
	 ...
	 */
	  ...
	  public FacultyModelInt getFacultyModel() { FacultyModelInt facultyModel =
	  (FacultyModelInt) modelCache.get("facultyModel"); if (facultyModel == null) {
	  if ("Hibernate".equals(DATABASE)) { facultyModel = new FacultyModelHibImpl();
	  }
	  
	  if ("JDBC".equals(DATABASE)) { facultyModel = new FacultyModelJDBCImpl();
	  }
	...
	public CourseModelInt getCourseModel() {
		...
		if (CourseModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { marksheetModel = new MarksheetModelJDBCImpl();
			 * }
			 */
	...
	public UserModelInt getUserModel() {
		...
		if (userModel == null) {
			if ("Hibernate".equals(DATABASE)) {
			  ...
			  if ("JDBC".equals(DATABASE)) { userModel = new UserModelJDBCImpl(); }
	...
	public CollegeModelInt getCollegeModel() {
		...
		if (collegeModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { collegeModel = new CollegeModelJDBCImpl(); }
			 */
	...
	public StudentModelInt getStudentModel() {
		...
		if (studentModel == null) {
			if ("Hibernate".equals(DATABASE)) {
			  ...
			  if ("JDBC".equals(DATABASE)) { studentModel = new StudentModelJDBCImpl(); }
	...
	public RoleModelInt getRoleModel() {
		...
		if (roleModel == null) {
			if ("Hibernate".equals(DATABASE)) {
			  ...
			  if ("JDBC".equals(DATABASE)) { roleModel = new RoleModelJDBCImpl(); }
